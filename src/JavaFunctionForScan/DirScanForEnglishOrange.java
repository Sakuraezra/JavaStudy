 ...
 */
public class DirScanForEnglishOrange {
	...
	public static ArrayList<Object> scanFilesWithNoRecursion(String folderPath) throws Exception {
		...
		if (!directory.isDirectory()) {
			...
			while (!queueFiles.isEmpty()) {
				...
				File file = new File("d:/script/updateEnglishWiki20190419.sql");
				if (!file.exists()) {
					file.createNewFile();
	...
	public static void main(String[] args) throws Exception {
			DirScanForEnglishOrange dirScanForEnglishOrange = new DirScanForEnglishOrange();
			String path = "d:/第一批英文柑橘百科--部署上线--77个";
		dirScanForEnglishOrange.scanFilesWithNoRecursion(path);

		// scanDir.orderByDate(path);

//		String test = "<p><strong>[Scientific Name]</strong><br>Citrus blossom midge（Contarinia citri Barnes）";
//
//		String[] contents = test.split("<p>");
//		String[] part = contents[1].trim().split("<br>");
//		String wikiTitleEng = part[1];
////			for(String s :tests){
////				System.out.println(s);
////			}
//		System.out.println(wikiTitleEng);
